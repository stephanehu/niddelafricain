<%-- 
    Document   : about
    Created on : Feb 4, 2016, 8:19:58 AM
    Author     : Stephane
--%>
...
<div class="about">	
    <div class="about-head">
        <div class="container">
            ...
            <div class="about-in">
                ...
                <h6 ><a href="blog_single.html">Enlight Group, for a Brighter Africa, We Guide - We Train - We Assist You in your Career</a></h6>
                <p>Since 3 years we have been in the city of Bangalore, helping more than 70 students in their study. Our syllabus is designed to give to our student
                    the best training available at time and make them ready to be productive in their own startup</p>
    ...
    <div class="about-middle">
        <div class="container">		
            <div class="col-md-8 about-mid">
                <h4>Oracle Certified Professional Java SE 7</h4>
                <h6><a href="blog_single.html">Java SE 7 is a great platform to built a desktop and distributed solution for enterprise </a> </h6>
            ...
            <div class="col-md-4 about-mid1">
                <p>
                    <img class="img img-responsive" src="images/cert.png" alt=""/>
                </p>
                <a href="images/eCertificate.pdf" class="hvr-sweep-to-right more-in">READ MORE</a>
                <a href="images/Pearson VUE - Checkout - Step 5_ Summary1.pdf" class="hvr-sweep-to-right more-in">Coming Soon</a>
    ...
    <div class="about-middle">
        <div class="container">	
            <div class="col-md-4 about-mid1">
                <p>
                    <img class="img img-responsive" src="images/cert1.png" alt=""/>
                </p>
                <a href="images/eCertificate_1.pdf" class="hvr-sweep-to-right more-in">READ MORE</a>

            </div>
            <div class="col-md-8 about-mid">
                <h4>Oracle Certified Associate Java SE &</h4>
                <h6><a href="blog_single.html">Java SE 7 is a great platform to built a desktop and distributed solution for enterprise</a> </h6>
                <p >Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages.
                    Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen</p>
            </div>
