    ...
    <div class="top-grid">
        ...
        <div class="grid-at">
            <div class="col-md-3 grid-city">
                <div class="grid-lo">
                    <a href="hostel_property?${cities.rows[0].idCITIES}">
            ...
            <div class="col-md-3 grid-city">
                <div class="grid-lo">
                    <a href="hostel_property?${cities.rows[1].idCITIES}">
                        <figure class="effect-layla">
            ...
            <div class="col-md-6 grid-city grid-city1">
                <div class="grid-me">
                    <div class="col-md-8 grid-lo1">
                        <div class=" grid-lo">
                            <a href="hostel_property?${cities.rows[2].idCITIES}">
                                <figure class="effect-layla">
                    ...
                    <div class="col-md-4 grid-lo2">
                        <div class=" grid-lo">
                            <a href="hostel_property?${cities.rows[3].idCITIES}">
                                <figure class="effect-layla">
                ...
                <div class="grid-me">
                    <div class="col-md-6 grid-lo3">
                        <div class=" grid-lo">
                            <a href="hostel_property?${cities.rows[4].idCITIES}">
                                <figure class="effect-layla">
                    ...
                    <div class="col-md-6 grid-lo4">
                        <div class=" grid-lo">
                            <a href="hostel_property?${cities.rows[5].idCITIES}">
                                <figure class="effect-layla">
