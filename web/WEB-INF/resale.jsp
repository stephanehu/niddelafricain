<%-- 
    Document   : resale
    Created on : Jan 21, 2016, 3:13:15 PM
    Author     : Stephane
--%>
...
<div class="single">
    ...
    <div class="container">
        ...
        <div class="buy-single">
            <h3>Residential Flats, Apartments is an ehanced feature that is coming soon</h3>

            <div class="box-sin">
                <div class="col-md-9 single-box">
                    <c:forEach var="toBuy" items="${propertiesToBuy.rows}" begin="2" end="7" step="1">
                        <div class="box-col">
                            ...
                            <div class="  col-sm-5 middle-side">
                                ...
                                <div class="   right-side">
                                    ...
                                    <a href="loan?${toBuy.idLOAN_PLAN}" class="hvr-sweep-to-right more" >Apply Loan</a>     
                                </div>
                            </div>
                            <div class="clearfix"> </div>
                        </div>
