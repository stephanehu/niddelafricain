...
<%-- 
    Document   : buyproperty
    Created on : Jan 21, 2016, 9:35:48 AM
    Author     : Stephane
--%>
                ...
                <div class="col-sm-3 check-top-single">
                    <div class="single-bottom">
                        ...
                        <ul>
                            ...
                            <li>
                                <input type="submit"  id="brand14" value="Find Your Home">
                        ...
                        <div class="box-col">
                            ...
                            <div class="  col-sm-5 middle-side">
                                ...
                                <div class="   right-side">
                                    <a href="contact?agent=${toBuy.idAGENTS}&property=${toBuy.idREALPROPERTIES}" class="hvr-sweep-to-right more" >Contact Builder</a> 
